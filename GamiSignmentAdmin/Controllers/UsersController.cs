...
namespace GamiSignmentAdmin.Controllers
{
    ...
    {
        private IManager<User> _um = new DllFacade().GetUserManager();

        // GET: Users
        public ActionResult Index()
        {
            return View(_um.Read());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,UserName,Email")] User user)
        {
